...
namespace ICSharpCode.XamlDesigner
{
	public class Toolbox
	{
		...
		void AddAssembly(string path, bool updateSettings)
		{
			...
			node.Path = path;
			node.Controls.Add(new ControlNode() { Type = typeof(Button) });
			node.Controls.Add(new ControlNode() { Type = typeof(TextBox) });
			node.Controls.Add(new ControlNode() { Type = typeof(Label) });
